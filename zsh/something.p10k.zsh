# Generated by Powerlevel10k configuration wizard on 2022-01-11 at 23:42 PST.
...
() {
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_NAME}${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_NAME}}'
  # POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_NAME}:${P9K_KUBECONTEXT_CLOUD_ZONE}${P9K_KUBECONTEXT_CLOUD_CLUSTER}:context${P9K_KUBECONTEXT_NAME}'
  ...
  typeset -g POWERLEVEL9K_AWS_CONTENT_EXPANSION='aws${P9K_AWS_PROFILE//\%/%%}${P9K_AWS_REGION:+ ${P9K_AWS_REGION//\%/%%}}'
